        ...
        rows.append(
            {
                ...
                "pillars": scored.get("pillars"),
                "framework": scored.get("framework"),
                "levels": scored.get("levels"),
                "buy_price": scored.get("buy_price"),
                "sell_price": scored.get("sell_price"),
                "stop_price": scored.get("stop_price"),
                "rsi": snap["rsi"],
                "macd_hist": snap["macd_hist"],
                "ret_5d": snap["ret_5d"],
                "ret_20d": snap["ret_20d"],
                "ret_63d": snap.get("ret_63d"),
